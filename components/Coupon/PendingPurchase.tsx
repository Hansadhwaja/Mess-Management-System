...
const PendingPurchase = () => {
  ...
  return (
    <div className="flex flex-col sm:flex-row shadow-2xl items-center p-4 bg-gradient-to-r from-orange-500 to-orange-300 w-full rounded-xl justify-between gap-2 sm:gap-0">

...
const Hero = async () => {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-8">
      <div className="bg-transparent rounded-2xl shadow-lg border p-6 sm:p-8 text-center transition hover:shadow-xl">
        <h2 className="text-lg sm:text-xl font-semibold text-gray-100 uppercase tracking-wide mb-2">
          Total Users
        </h2>
